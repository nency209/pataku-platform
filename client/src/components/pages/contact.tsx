...
const ContactSchema = Yup.object().shape({
  name: Yup.string().min(2, "Too Short").max(50, "Too long").required("Your name is required"),
...
export const metadata = {
  ...
  description: "Get in touch with us. Find our address, contact info, and more.",
};
    ...
    <div className="mx-auto xl:max-w-6xl lg:max-w-4xl md:max-w-2xl px-4 sm:px-6 lg:px-0">
      <div className="grid grid-cols-1 lg:grid-cols-3 py-12 lg:py-24 gap-10 lg:gap-20">
        ...
        <div className="space-y-8">
          <h1 className="text-2xl lg:text-3xl font-lato">
            Contact Us
          </h1>
          ...
          <div className="border-b space-y-4 py-4">
            <div className="flex items-center gap-4">
              <Image src="/img/contact-icon1.jpg" width={34} height={40} alt="Address" />
          ...
          <div className="border-b space-y-4 py-4">
            <div className="flex items-center gap-4">
              <Image src="/img/contact-icon2.jpg" width={34} height={40} alt="Phone" />
              <h4 className="font-bold text-lg lg:text-xl font-lato">
                Phone
              </h4>
            </div>
          ...
          <div className="border-b space-y-4 py-4">
            <div className="flex items-center gap-4">
              <Image src="/img/contact-icon3.jpg" width={34} height={40} alt="Email" />
              <h4 className="font-bold text-lg lg:text-xl font-lato">
                Email
              </h4>
            </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <Formik validationSchema={ContactSchema} initialValues={InitialValues} onSubmit={handleSubmit}>
            <Formikform className="space-y-6">
              ...
              <div>
                <label>Message</label>
                <Field as="textarea" name="message" className="border p-2 w-full rounded min-h-[120px]" />
