            ...
            <div className="border-b border-gray-200">
                    ...
                    <div className="flex items-center justify-between py-3">
                        ...
                        <nav className="hidden md:flex items-center space-x-6">
                            <div className="relative" ref={dropdownRef}>
                                <button
                                    className="text-gray-900 font-medium border-b-2 border-amber-500 pb-1 flex items-center space-x-1"
                                ...
                                {isHomeDropdownOpen && (
                                    <div className="absolute top-full left-0 mt-1 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                                        <div className="py-2">
                                            <a href="/" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Home Shop 1</a>
                                            <a href="/home-2" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Home Shop 2</a>
                                            <a href="/home-3" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Home Shop 3</a>
                                            <a href="/home-4" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Home Shop 4</a>
                                            <a href="/home-rtl" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Home RTL Version</a>
                                        </div>
                                    </div>
                                )}
                            </div>
                ...
                <div className="md:hidden border-t border-gray-200 bg-white">
                    <nav className="flex flex-col py-4 px-4 space-y-3">
                        ...
                        <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors py-2">SHOP</a>
                        <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors py-2">PRODUCT</a>
